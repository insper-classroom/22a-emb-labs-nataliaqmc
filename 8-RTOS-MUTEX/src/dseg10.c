...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    /* U+0043 "C" */
    0x7a, 0x8, 0x20, 0x83, 0xf0,

    /* U+006F "o" */
    0x7e, 0x18, 0x61, 0x87, 0xe0,

    /* U+00B0 "°" */
    0x7a, 0x18, 0x61, 0x87, 0xe0
};
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 79, .adv_w = 131, .box_w = 6, .box_h = 6, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 84, .adv_w = 131, .box_w = 6, .box_h = 6, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 89, .adv_w = 131, .box_w = 6, .box_h = 6, .ofs_x = 1, .ofs_y = 5}
};
...
static const uint16_t unicode_list_0[] = {
    ...
    0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x23, 0x4f,
    0x90
};
